...
//Fetch Order
await page.goto('https://app-staging.qlub.cloud/qr/sa/Auto_MoyasarCom/12/_/_/dc0f754174');
...
await page.locator('#mysr-cc-number').fill('4201320000311101');
...
await page.locator('//button[@type="submit" and contains(@class, "button")]').click();
  ...
  await expect(tableNumberText).toHaveText('Table 12 (Table 2)');
