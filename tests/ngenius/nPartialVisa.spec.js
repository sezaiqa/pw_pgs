...
test('test', async ({ page }) => {
  ...
  await page.goto('https://app-staging.qlub.cloud/qr/ae/Auto_NgeniusSezai/8/_/_/f11cd43f49');
  ...
  await threeDsIframe.getByRole('button', { name: 'Submit' }).click();
   ...
   await expect(page.locator('p.MuiTypography-root.MuiTypography-body1.css-1xyuldj')).toHaveText('Table 8 (Table 1)');
