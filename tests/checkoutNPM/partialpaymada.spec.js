...
test('test', async ({ page }) => {
  ...
  await page.goto('https://app-staging.qlub.cloud/qr/ae/Auto_CheckoutNPM/7/_/_/48785232d8');
  ...
  await page.frameLocator('iframe[name="checkout-frames-cardNumber"]').getByPlaceholder('1234 1234 1234').fill('4847832822377953');
  // Expiry Date
  ...
  await expect(tableNumberText).toHaveText('Table 7 (Table 1)');
});
