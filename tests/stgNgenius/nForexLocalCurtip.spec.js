...
test('test', async ({ page }) => {
  ...
  await page.goto('https://app-staging.qlub.cloud/qr/ae/Auto_NgeniusForex/4/_/_/e23578ab6a');
  ...
  await threeDsIframe.getByRole('button', { name: 'Submit' }).click();
   ...
   await expect(page.locator('p.MuiTypography-root.MuiTypography-body1.css-1xyuldj')).toHaveText('Table 4 (Table 1)');
