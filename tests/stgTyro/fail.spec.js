...
test('test', async ({ page }) => {
  await page.goto('https://app-staging.qlub.cloud/qr/au/Auto_TyroSezai/1/_/_/62c3bc4230');
...
await page.frameLocator('[id="\\#card-number"]').getByPlaceholder('1234 1234 1234').fill('5123450000000008');

// Expiry Month
await page.frameLocator('[id="\\#expiry-month"]').getByPlaceholder('MM').click();
await page.frameLocator('[id="\\#expiry-month"]').getByPlaceholder('MM').fill('05');
