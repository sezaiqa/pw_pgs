...
test('test', async ({ page }) => {
  ...
  await page.goto('https://app-staging.qlub.cloud/qr/ae/Disc_Auto_Checkout/2/_/_/771b0ba82d');
  ...
  await page.waitForSelector('p.MuiTypography-root.MuiTypography-body1.css-1ih4cbc');
  await page.waitForSelector('p.MuiTypography-root.MuiTypography-body1.css-1xyuldj');
