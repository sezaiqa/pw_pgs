...
test('test', async ({ page }) => {
  await page.goto('https://app-staging.qlub.cloud/qr/sg/Auto_AdyenSezai/10/_/_/284abecbe8');
  ...
  await page.frameLocator('iframe[title="Iframe for card number"]').getByPlaceholder('5678 9012 3456').fill('4242420100058064');
...
const tableNumberText = await page.$('p.MuiTypography-root.MuiTypography-body1.css-1xyuldj');
  ...
  expect(await tableNumberText.textContent()).toContain('Table 10 (Table 2)');
});
