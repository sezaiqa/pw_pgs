...
test('test', async ({ page }) => {
  ...
  await page.goto('https://app-staging.qlub.cloud/qr/ae/Auto_NgeniusSezai/10/_/_/4fce58ac75');
  ...
  await threeDsIframe.getByRole('button', { name: 'Submit' }).click();
   ...
   await expect(page.locator('p.MuiTypography-root.MuiTypography-body1.css-1xyuldj')).toHaveText('Table 10 (Table 2)');
